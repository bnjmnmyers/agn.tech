...
<body>
	<div id="outer-wrapper">
        ...
        <div id="content-wrapper">
            <div id="about-blurb-container" class="blurb-container">
            	<a href="about.php"><img src="images/index/icons/about-icon.svg" height="57" width="54" alt="About Alchemy Global Networks" title="About Icon" /></a>
...
makes Alchemy Global Networks the gold standard in network engineering.</p>
            ...
            <div id="services-blurb-container" class="blurb-container">
            	<a href="services.php"><img src="images/index/icons/services-icon.svg" height="57" width="54" alt="Alchemy Global Networks Services" title="Services Icon" /></a>
...
<p class="blurb">From assessment to cybersecurity, from ongoing support to network and infrastructure design, trust your network services to no one but the very best. Find out more about our unmatched services and capabilities.</p>
            ...
            <div id="contact-blurb-container" class="blurb-container">
            	<a href="contact.php"><img src="images/index/icons/contact-icon.svg" height="57" width="54" alt="Contact Alchemy Global Networks" title="Contact Icon" /></a>
